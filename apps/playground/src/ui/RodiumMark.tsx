...
// the brand mark is this site's, not the kit's: a kit that ships one company's
// logo is a kit nobody else can wear.
...
export interface RodiumMarkProps extends SVGProps<SVGSVGElement> {
  size?: number
  title?: string
}

export function RodiumMark({ size = 16, title, ...rest }: RodiumMarkProps) {
