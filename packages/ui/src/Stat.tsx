...
// the arrow and the word carry the direction alongside the colour, so the
// reading does not depend on telling green from red.
const TREND: Record<
  StatTrend,
  {
    ink: string
...
export function Stat({ label, value, unit, trend, delta, className }: StatProps) {
